...
const widthMinusMediumPadding = Dimensions.get('screen').width - SpacingMedium - SpacingMedium
...
//SQL
const AD_TABLE_SELECT_PARAMS = ['dateOfCreation', 'Views', 'Addition to Wheel', 'Spins Won', 'References' ]
